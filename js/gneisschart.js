...
Gneiss.defaultGneissChartConfig = {
	...
	maxColumnWidth: 5, // the maximum width of a column as a percent of the available chart width	primaryAxisPosition: "right", // the first axis will be rendered on this side, "right" or "left" only
	...
	xAxisRef: [
		{
			name: "names",
			data: ["Bangladeshi", "Chinese", "Filipino", "Indian", "Japanese", "Korean", "Pakistani", "Vietnamese"]
		}
	],
	sourceline: "Census Bureau by Pew and AAFNY",
